...
class TextDetectionWindow(QMainWindow):
    ...
    def classify_events(self):
        ...
        global folder_counter_4
        global folder_counter_Out
        global counting_that_place
        folder_counter_4=1
            ...
            if '-' in i:  
                ...
                if temp[0].isdigit() and temp[1].isdigit() :
                    ...
                    if Fisrt_iteration == True:
                        ...
                        global Score_index_prev
                        Score_index_prev=j-1
                        Out_prev=int(temp[1])
                        global Out_index_prev
                        Out_index_prev=j-1
                        ...
                        if (Score_curr-Score_prev)==4:
                            ...
                            print("Splitting the filname and getting the seconds info from it ")
